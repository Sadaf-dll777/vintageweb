      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto flex items-end justify-between gap-3">
          ...
          <button
            ...
            className="group/btn inline-flex items-center justify-center gap-1.5 rounded-full bg-primary px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-primary-foreground shadow-[0_6px_20px_-8px_var(--color-primary)] transition-all duration-300 ease-out hover:scale-110 hover:brightness-110 hover:shadow-[0_10px_28px_-8px_var(--color-primary)] active:scale-95"
          >
